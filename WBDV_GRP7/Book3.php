...
<head>
    ...
    <title>The Subtle Art of Not Giving a F*ck | Uplift Bookstore</title>
    <style>
       body {
...
<body>
 ...
 <div class="categories-container">
    ...
    <div class="book-detail-container">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzzZW-gz_vtgxuN0f2w_HwDXjbifEdCFxhwg&s" alt="Book Cover">
        <div class="book-detail">
            <h1 class="book-title">The Subtle Art of Not Giving a F*ck</h1>
            <p class="book-author">By Mark Manson</p>
            <p class="book-price">₱845</p>
            <p class="book-description">
               <strong>#1 New York Times Bestseller</strong><br>
</br>
